export const commentsKeys = {
  ...
  detail: (commentId: string) =>
    [...commentsKeys.details(), { commentId }] as const,

  mutations: () => [...commentsKeys.all, 'mutation'] as const,
  mutation: {
    add: (threadId: string) =>
      [...commentsKeys.mutations(), 'add', { threadId }] as const,
    update: (commentId: string) =>
      [...commentsKeys.mutations(), 'update', { commentId }] as const,
    delete: (commentId: string) =>
      [...commentsKeys.mutations(), 'delete', { commentId }] as const,
  },
};
