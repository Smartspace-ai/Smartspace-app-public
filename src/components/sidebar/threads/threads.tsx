...
export function Threads() {  
  ...
  useEffect(() => {
    ...
    if (!isLoading && !threadId && (threads?.length ?? 0) === 0 && hasAutoGeneratedRef.current !== urlWorkspaceId) {
      ...
      hasAutoGeneratedRef.current = urlWorkspaceId || null; // Mark this workspace as auto-generated
    ...
    if (threads && (threads.length ?? 0) > 0 && (!threadId || (autoCreatedThreadId && threadId === autoCreatedThreadId))) {
