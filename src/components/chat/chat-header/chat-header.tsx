...
import { NousButton } from '@/components/ui/nous-button';
    ...
    <header className="ss-chat__header flex h-[54px] shrink-0 items-center gap-2 bg-background border-b ">
      ...
      <div className="flex items-center gap-2 px-4">
        ...
        <NousButton
          variant="ghost"
          size="icon"
          title="NousGroup Doris"
          onClick={() => window.open('https://doris.nousgroup.com.au/x/CYh4D', '_blank')}
        >
        ...
        <NousButton
          ...
          onClick={() => window.open('https://wkf.ms/45gm01u', '_blank')}
        >
