...
const TAG_STYLES: Record<string, { chip: string; gradient?: string }> = {
  safe: {
    ...
    gradient:
      'via-emerald-500/5 to-emerald-500/10 dark:via-emerald-400/10 dark:to-emerald-400/20',
  },
  unsafe: {
    chip: 'bg-red-100 text-red-700 border-red-200',
    gradient:
      'via-red-500/5 to-red-500/10 dark:via-red-400/10 dark:to-red-400/20',
  },
  internal: {
    chip: 'bg-emerald-100 text-emerald-700 border-emerald-200',
    gradient:
...
const DEFAULT_GRADIENT =
  'via-primary/5 to-primary/10 dark:via-primary/10 dark:to-primary/20';
