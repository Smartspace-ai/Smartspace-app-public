...
export const getChatAPI = () => {
   ...
   */
  const getFilesIdUri = (id: string, params?: GetFilesIdUriParams) => {
  ...
  const getFlowRunsIdVariables = (id: string) => {
    return apiMutator<
      | GetFlowRunsIdVariables200One
      | GetFlowRunsIdVariables200Two
      | GetFlowRunsIdVariables200Three
 ...
 */
  ...
  const getMessageThreadsIdMessages = (
    ...
    return apiMutator<PagedDataCollectionMessageMessage>({
      url: `/MessageThreads/${id}/messages`,
      method: 'GET',
      params,
    });
  };
   ...
   */
  const getModels = (params?: GetModelsParams) => {
   ...
   */
  const getModelsId = (id: string) => {
    return apiMutator<ModelModel>({ url: `/Models/${id}`, method: 'GET' });
  };
  ...
  const getWorkSpacesIdMessageThreads = (
    ...
    return apiMutator<PagedDataCollectionMessageThreadMessageThreadSummary>({
      url: `/WorkSpaces/${id}/messageThreads`,
      method: 'GET',
      params,
    });
  };
...
export type GetDataspacesDataSpaceIdDocumentsItemSasResult = NonNullable<
  Awaited<
    ReturnType<
      ReturnType<typeof getChatAPI>['getDataspacesDataSpaceIdDocumentsItemSas']
    >
  >
>;
export type GetFilesIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getFilesId']>>
>;
export type PostFilesResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['postFiles']>>
>;
export type GetFilesIdDownloadResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getFilesIdDownload']>>
>;
export type GetFilesIdUriResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getFilesIdUri']>>
>;
export type GetFlowRunsIdVariablesResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getFlowRunsIdVariables']>>
>;
export type PutFlowRunsIdVariablesVariableNameResult = NonNullable<
  Awaited<
    ReturnType<
      ReturnType<typeof getChatAPI>['putFlowRunsIdVariablesVariableName']
    >
  >
>;
export type PostMessagesIdCommentsResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['postMessagesIdComments']>>
>;
export type GetMessagesIdCommentsResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getMessagesIdComments']>>
>;
export type PostMessagesResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['postMessages']>>
>;
export type PostMessagesIdValuesResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['postMessagesIdValues']>>
>;
export type DeleteMessagesIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['deleteMessagesId']>>
>;
export type PostWorkspacesWorkspaceIdMessagethreadsResult = NonNullable<
  Awaited<
    ReturnType<
      ReturnType<typeof getChatAPI>['postWorkspacesWorkspaceIdMessagethreads']
    >
  >
>;
export type GetMessageThreadsIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getMessageThreadsId']>>
>;
export type DeleteMessageThreadsIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['deleteMessageThreadsId']>>
>;
export type GetWorkspacesWorkspaceIdMessagethreadsIdResult = NonNullable<
  Awaited<
    ReturnType<
      ReturnType<typeof getChatAPI>['getWorkspacesWorkspaceIdMessagethreadsId']
    >
  >
>;
export type GetMessageThreadsIdMessagesResult = NonNullable<
  Awaited<
    ReturnType<ReturnType<typeof getChatAPI>['getMessageThreadsIdMessages']>
  >
>;
export type GetWorkspacesWorkspaceIdMessagethreadsIdMessagesResult =
  NonNullable<
    Awaited<
      ReturnType<
        ReturnType<
...
export type PutMessageThreadsIdNameResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['putMessageThreadsIdName']>>
>;
export type PutMessageThreadsIdFavoritedResult = NonNullable<
  Awaited<
    ReturnType<ReturnType<typeof getChatAPI>['putMessageThreadsIdFavorited']>
  >
>;
export type PostMessageThreadsIdCommentsResult = NonNullable<
  Awaited<
    ReturnType<ReturnType<typeof getChatAPI>['postMessageThreadsIdComments']>
  >
>;
export type GetMessageThreadsIdCommentsResult = NonNullable<
  Awaited<
    ReturnType<ReturnType<typeof getChatAPI>['getMessageThreadsIdComments']>
  >
>;
export type GetModelsResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getModels']>>
>;
export type GetModelsIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getModelsId']>>
>;
export type GetWorkSpacesIdResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getWorkSpacesId']>>
>;
export type GetWorkSpacesResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getWorkSpaces']>>
>;
export type GetWorkSpacesIdAccessResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getWorkSpacesIdAccess']>>
>;
export type GetWorkSpacesIdUsersResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getChatAPI>['getWorkSpacesIdUsers']>>
>;
export type GetWorkSpacesIdMessageThreadsResult = NonNullable<
  Awaited<
    ReturnType<ReturnType<typeof getChatAPI>['getWorkSpacesIdMessageThreads']>
  >
>;
